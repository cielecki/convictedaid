...
function createStandardSiegeMachines(SIEGE_ATTACK_TRAIT, siegeTraits) {
    ...
    var CAN_NOT_BE_ATTACKED_BY_RANGED = {'name': 'Immune to ranged', description: "Ranged units can not attack siege weapons in step 1 and 6." };

    return [
        { name: 'Battering ram', ST: 0, SU: 0, EN: 5, RST: 0, activateDuringSiegePhase: true, icon:'images/batteringram.png', size:'16', traits:[RAM_TRAIT, CAN_NOT_BE_ATTACKED_BY_RANGED].concat(siegeTraits.slice(0))},
        { name: 'Ballista', ST: 0, SU: 0, EN: 3, RST: '2xd3', activateDuringSiegePhase: true, icon:'images/ballista.png', size:'16', traits:[BALLISTA_TRAIT, SIEGE_ATTACK_TRAIT, CAN_NOT_BE_ATTACKED_BY_RANGED].concat(siegeTraits.slice(0))},
        { name: 'Catapult', ST: 0, SU: 0, EN: 3, RST: '3+d3', activateDuringSiegePhase: true, icon:'images/catapult.png', size:'16', traits:[CATAPULT_TRAIT, SIEGE_ATTACK_TRAIT, CAN_NOT_BE_ATTACKED_BY_RANGED].concat(siegeTraits.slice(0))},
        { name: 'Trebuchet', ST: 0, SU: 0, EN: 5, RST: '4+d3', activateDuringSiegePhase: true, icon:'images/trebuchet.png', size:'16', traits:[TREBUCHET_TRAIT, SIEGE_ATTACK_TRAIT, CAN_NOT_BE_ATTACKED_BY_RANGED].concat(siegeTraits.slice(0))},
        { name: 'Cover', ST: 0, SU: 0, EN: 6, RST: 0, activateDuringSiegePhase: true, icon:'images/cover.png', size:'16', traits:[COVER_TRAIT, CAN_NOT_BE_ATTACKED_BY_RANGED].concat(siegeTraits.slice(0))},
        { name: 'Bridge', ST: 0, SU: 0, EN: 4, RST: 0, activateDuringSiegePhase: true, icon:'images/bridge.png', size:'16', traits:[BRIDGE_TRAIT, CAN_NOT_BE_ATTACKED_BY_RANGED].concat(siegeTraits.slice(0))},
        { name: 'Siege Tower', ST: 0, SU: 0, EN: 7, RST: 0, activateDuringSiegePhase: true, icon:'images/siegetower.png', size:'16', traits:[SIEGE_TOWER_TRAIT, CAN_NOT_BE_ATTACKED_BY_RANGED].concat(siegeTraits.slice(0))}
    ];
}
